      ...
      blocks: [
        ...
        { k: 'h2', text: 'What comes out' },
        {
          ...
          items: [
            ...
            'A **review pass** over the diff, in the PR body: what it does, and what a reviewer should look at, each finding tied to the acceptance criterion or design claim it bears on. Advisory — it never blocks the build, and nothing it raises has been acted on.',
